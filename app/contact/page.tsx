						...
						return (
							<Card key={s.href}>
								<Link
									...
									className="group motion-enter relative flex min-h-[18rem] flex-col items-start justify-between gap-8 p-6 transition-transform duration-300 [transition-timing-function:var(--ease-out-quart)] hover:-translate-y-1 active:scale-[0.98] focus-visible:rounded-3xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d8a55f] focus-visible:ring-offset-2 focus-visible:ring-offset-[#191c28] sm:min-h-[20rem] sm:p-8"
									style={{ animationDelay }}
								>
									<span className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full border border-[#445173] bg-[#2b3243] text-zinc-200 transition-all duration-300 [transition-timing-function:var(--ease-out-quart)] group-hover:scale-105 group-hover:border-[#d8a55f]/80 group-hover:text-white motion-reduce:transform-none">
										{s.icon}
									</span>

									<div className="z-10 flex w-full min-w-0 flex-col">
										<span className="font-display text-[clamp(1.25rem,2.2vw,1.85rem)] leading-[1.14] tracking-[-0.01em] text-zinc-100 transition-colors group-hover:text-white [overflow-wrap:anywhere]">
											{s.handle}
										</span>
